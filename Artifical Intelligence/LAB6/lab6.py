...
xtrain1 = np.load('dataset1_xtrain.npy')
ytrain1 = np.load('dataset1_ytrain.npy')
xtest1 = np.load('dataset1_xtest.npy')
ytest1 = np.load('dataset1_ytest.npy')
print(xtrain1.shape)
print(ytrain1.shape)
print(xtest1.shape)
print(ytest1.shape)
...
ytrain1 = np.reshape(ytrain1,(921,))
ytest1 = np.reshape(ytest1,(230,))
